...
bool test_matrix_calculator_100m(void) {
    ...
    matrix_calculator_result_t* mult_result = matrix_multiply_lum_optimized(calculator, calculator, config);
    ...
    bool success = false;
    if (mult_result && mult_result->operation_success) {
        ...
        success = true;
        matrix_calculator_result_destroy(&mult_result);
    } else {
