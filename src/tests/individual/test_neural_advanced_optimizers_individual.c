// Test individuel neural_advanced_optimizers - Template standard README.md
#include <stdio.h>
#include <time.h>
#include <assert.h>
#include <stdlib.h>
...
#define TEST_MODULE_NAME "neural_advanced_optimizers"
