// Test individuel tsp_optimizer - Template standard README.md
#include <stdio.h>
#include <time.h>
#include <assert.h>
#include <stdlib.h>
...
#define TEST_MODULE_NAME "tsp_optimizer"
