...
// Constantes Collatz
#define COLLATZ_MAX_ITERATIONS 10000000
#define COLLATZ_MAX_NUMBER 1000000000000ULL
#define COLLATZ_MAGIC_NUMBER 0x434F4C5A
#define COLLATZ_DESTROYED_MAGIC 0xDEADBEEF
#define COLLATZ_CACHE_SIZE 1000000
