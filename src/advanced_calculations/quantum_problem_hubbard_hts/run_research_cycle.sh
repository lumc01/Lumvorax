<<<<<<< HEAD
diff --git a/src/advanced_calculations/quantum_problem_hubbard_hts/run_research_cycle.sh b/src/advanced_calculations/quantum_problem_hubbard_hts/EXTRACTION_AGENT/run_research_cycle.sh
similarity index 57%
rename from src/advanced_calculations/quantum_problem_hubbard_hts/run_research_cycle.sh
rename to src/advanced_calculations/quantum_problem_hubbard_hts/EXTRACTION_AGENT/run_research_cycle.sh
index 293ae85ec487cff4c494177d5f49d611f2ff3427..d3269709a6ee729f306fa31b0374f0dfa31dac2d 100755
--- a/src/advanced_calculations/quantum_problem_hubbard_hts/run_research_cycle.sh
+++ b/src/advanced_calculations/quantum_problem_hubbard_hts/EXTRACTION_AGENT/run_research_cycle.sh
@@ -1,48 +1,90 @@
 #!/usr/bin/env bash
 set -euo pipefail
...
echo "Research cycle terminé: $RUN_DIR"
>>>>>>> 4c02cf736ae0fe7a860d87da70e5de971d59054d
