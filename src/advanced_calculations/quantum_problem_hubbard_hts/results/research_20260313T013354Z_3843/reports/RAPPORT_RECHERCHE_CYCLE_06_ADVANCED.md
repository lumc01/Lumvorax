...
Run ID: `research_20260313T013354Z_3843`
...
- **Résultats**: baseline `./results/research_20260313T013354Z_3843/logs/baseline_reanalysis_metrics.csv`, tests `./results/research_20260313T013354Z_3843/tests/new_tests_results.csv`, matrice experte `./results/research_20260313T013354Z_3843/tests/expert_questions_matrix.csv`.
...
Voir `./results/research_20260313T013354Z_3843/tests/expert_questions_matrix.csv`.
...
- Comparaison chiffrée exportée: `./results/research_20260313T013354Z_3843/tests/benchmark_comparison_qmc_dmrg.csv` et `./results/research_20260313T013354Z_3843/tests/benchmark_comparison_external_modules.csv`.
...
- Log: `./results/research_20260313T013354Z_3843/logs/research_execution.log`
- Bruts: `./results/research_20260313T013354Z_3843/logs/baseline_reanalysis_metrics.csv` `./results/research_20260313T013354Z_3843/tests/new_tests_results.csv`
- Matrice experte: `./results/research_20260313T013354Z_3843/tests/expert_questions_matrix.csv`
- Provenance: `./results/research_20260313T013354Z_3843/logs/provenance.log`
- Métadonnées physiques: `./results/research_20260313T013354Z_3843/tests/module_physics_metadata.csv`
- Benchmarks: `./results/research_20260313T013354Z_3843/tests/benchmark_comparison_qmc_dmrg.csv` `./results/research_20260313T013354Z_3843/tests/benchmark_comparison_external_modules.csv`
- Observables normalisés: `./results/research_20260313T013354Z_3843/logs/normalized_observables_trace.csv`
- Stabilité numérique: `./results/research_20260313T013354Z_3843/tests/numerical_stability_suite.csv`
- Dérivées/variance temporelles: `./results/research_20260313T013354Z_3843/tests/temporal_derivatives_variance.csv`
- Cas jouet: `./results/research_20260313T013354Z_3843/tests/toy_model_validation.csv`
