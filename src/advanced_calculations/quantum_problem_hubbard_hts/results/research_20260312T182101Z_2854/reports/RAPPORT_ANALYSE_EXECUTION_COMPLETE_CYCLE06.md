...
Run: `research_20260312T182101Z_2854`
UTC: `2026-03-12T18:21:14.063101+00:00`
...
- Tests en échec détectés :
  ...
  - `new_tests_results`: benchmark/qmc_dmrg_rmse -> `FAIL` (value=1284425.7876106792)
  - `new_tests_results`: benchmark/qmc_dmrg_mae -> `FAIL` (value=810134.5019727040)
  - `new_tests_results`: benchmark/qmc_dmrg_within_error_bar -> `FAIL` (value=6.666667)
  - `new_tests_results`: benchmark/qmc_dmrg_ci95_halfwidth -> `FAIL` (value=650009.1321544526)
  - `new_tests_results`: benchmark/external_modules_rmse -> `FAIL` (value=30626.4922324964)
  - `new_tests_results`: benchmark/external_modules_mae -> `FAIL` (value=20345.1730495745)
