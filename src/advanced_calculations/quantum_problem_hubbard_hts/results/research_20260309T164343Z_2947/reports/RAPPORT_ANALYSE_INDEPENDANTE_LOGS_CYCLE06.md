...
Run analysé: `research_20260309T164343Z_2947`
Horodatage UTC: `2026-03-09T16:49:33.426735+00:00`
...
- Modules metadata: **13**
- Moyenne énergie brute: **-298.087579**
- Moyenne pairing brut: **102136.933974**
...
- Couverture questions expertes complètes: **10/19 (52.63%)**
...
- Points en échec détectés et conservés (pas masqués):
  ...
  - `new_tests_results`: verification/independent_calc -> FAIL (value=1291133.4647641242)
  - `new_tests_results`: dt_sweep/dt_convergence -> FAIL (value=0)
  - `new_tests_results`: benchmark/qmc_dmrg_rmse -> FAIL (value=1284847.3939481000)
  - `new_tests_results`: benchmark/qmc_dmrg_mae -> FAIL (value=810448.6723124936)
  - `new_tests_results`: benchmark/qmc_dmrg_within_error_bar -> FAIL (value=0.000000)
  - `new_tests_results`: benchmark/qmc_dmrg_ci95_halfwidth -> FAIL (value=650222.4943993882)
  - `new_tests_results`: benchmark/external_modules_rmse -> FAIL (value=31059.9397499956)
  - `new_tests_results`: benchmark/external_modules_mae -> FAIL (value=20661.5728577960)
...
- Score pondéré indépendant: **68.39%**
