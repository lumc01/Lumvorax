...
Horodatage UTC: `2026-03-19T17:56:21.822652+00:00`
...
- Vérification famille par famille des tests PASS/FAIL/OBSERVED:
  ...
  - `dt_sweep`: PASS=4 FAIL=0 OBSERVED=0 (pass=100.00%)
  - `dynamic_pumping`: PASS=4 FAIL=0 OBSERVED=0 (pass=100.00%)
  ...
  - `sensitivity`: PASS=8 FAIL=0 OBSERVED=0 (pass=100.00%)
...
- Couverture questions expertes complètes: **25/25 (100.00%)**
...
- Score pondéré indépendant: **89.85%**
