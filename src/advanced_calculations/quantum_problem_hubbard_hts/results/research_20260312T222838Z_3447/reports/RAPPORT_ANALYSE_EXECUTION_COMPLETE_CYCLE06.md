...
Run: `research_20260312T222838Z_3447`
UTC: `2026-03-12T22:28:51.562959+00:00`
...
- `partial`: **6**
- `absent`: **0**
- Couverture experte complète: **68.42%**
...
- Tests en échec détectés :
  ...
  - `numerical_stability_suite`: energy_conservation quantum_field_noneq -> `FAIL` (energy_density_drift_max=0.0000061712)
  ...
  - `numerical_stability_suite`: energy_conservation multi_state_excited_chemistry -> `FAIL` (energy_density_drift_max=0.0000047556)
  - `numerical_stability_suite`: energy_conservation bosonic_multimode_systems -> `FAIL` (energy_density_drift_max=0.0000036550)
  - `numerical_stability_suite`: energy_conservation multiscale_nonlinear_field_models -> `FAIL` (energy_density_drift_max=0.0000054076)
  - `numerical_stability_suite`: energy_conservation far_from_equilibrium_kinetic_lattices -> `FAIL` (energy_density_drift_max=0.0000045557)
...
- Analyse spectrale: **50.00%**
- Couverture questions expertes complètes: **68.42%**
