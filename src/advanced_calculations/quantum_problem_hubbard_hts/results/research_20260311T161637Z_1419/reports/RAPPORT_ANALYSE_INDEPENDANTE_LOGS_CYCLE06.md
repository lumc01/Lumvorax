...
Horodatage UTC: `2026-03-11T16:25:48.602080+00:00`
...
- Modules metadata: **13**
- Moyenne énergie brute: **-0.178511**
- Moyenne pairing brut: **0.944686**
...
- Points en échec détectés et conservés (pas masqués):
  ...
  - `new_tests_results`: verification/independent_calc -> FAIL (value=8.3632817207)
  - `new_tests_results`: benchmark/qmc_dmrg_rmse -> FAIL (value=1284425.8332784246)
  - `new_tests_results`: benchmark/qmc_dmrg_mae -> FAIL (value=810134.6065411962)
  - `new_tests_results`: benchmark/qmc_dmrg_within_error_bar -> FAIL (value=0.000000)
  - `new_tests_results`: benchmark/qmc_dmrg_ci95_halfwidth -> FAIL (value=650009.1552655206)
  - `new_tests_results`: benchmark/external_modules_rmse -> FAIL (value=30626.5806812931)
  - `new_tests_results`: benchmark/external_modules_mae -> FAIL (value=20345.2877130879)
...
- Score pondéré indépendant: **68.81%**
