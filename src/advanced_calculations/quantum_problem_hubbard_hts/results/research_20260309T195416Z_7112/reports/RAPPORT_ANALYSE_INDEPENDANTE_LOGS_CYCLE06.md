...
Horodatage UTC: `2026-03-09T20:00:08.062339+00:00`
...
- Modules metadata: **13**
- Moyenne énergie brute: **-0.263741**
- Moyenne pairing brut: **0.983769**
- Moyenne sign ratio brut: **-0.004999**
...
- Points en échec détectés et conservés (pas masqués):
  ...
  - `new_tests_results`: verification/independent_calc -> FAIL (value=8.4715613803)
  - `new_tests_results`: dt_sweep/dt_convergence -> FAIL (value=0)
  - `new_tests_results`: benchmark/qmc_dmrg_rmse -> FAIL (value=1284425.9034935166)
  - `new_tests_results`: benchmark/qmc_dmrg_mae -> FAIL (value=810134.6715830286)
  - `new_tests_results`: benchmark/qmc_dmrg_within_error_bar -> FAIL (value=0.000000)
  - `new_tests_results`: benchmark/qmc_dmrg_ci95_halfwidth -> FAIL (value=650009.1907992598)
  - `new_tests_results`: benchmark/external_modules_rmse -> FAIL (value=30626.6435162046)
  - `new_tests_results`: benchmark/external_modules_mae -> FAIL (value=20345.3527882769)
