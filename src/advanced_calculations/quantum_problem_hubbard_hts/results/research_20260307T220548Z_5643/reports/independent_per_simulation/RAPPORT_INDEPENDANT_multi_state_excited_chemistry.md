# RAPPORT INDÉPENDANT — multi_state_excited_chemistry
...
- Points = 23 ; lattice_sites = 81.
- Énergie min/max = -13830.4044175484 / 590509.9493193902.
- Énergie/site fin = 7290.246287893707 (rang énergie=10/13).
- Pairing start/end = 80.8859871435 / 153395.6660663908.
- Pairing normalisé fin = 1893.7736551406274 (rang pairing=3/13).
- Sign ratio min/max = -0.0617283951 / 0.003274825.
- CPU/RAM moyens = 16.379565217391303% / 3.32%.
- Entropies (bits): energy=2.869051, pairing=3.914866, sign_abs=0.765364, combined=3.391959.

## Phase 3 — Vérification exhaustive A→Z
- Trace locale: step 0->2200, dE/dstep=268.426955, dPairing/dstep=69.688536.
- Corrélations par lag:
- lag=1: pairing_corr=0.999989, energy_corr=0.997552, sign_corr=0.883539
- lag=2: pairing_corr=0.999957, energy_corr=0.989732, sign_corr=0.879462
- lag=4: pairing_corr=0.999840, energy_corr=0.955529, sign_corr=-0.219380
- lag=8: pairing_corr=0.999664, energy_corr=0.800003, sign_corr=-0.501782
- lag=16: pairing_corr=0.999983, energy_corr=-0.992317, sign_corr=0.754454
