...
- `results/research_<...>/reports/RAPPORT_RECHERCHE_CYCLE_02.md`
...
## Objectif v3
Le cycle v3 force des scores mesurés et audités sur 6 axes (isolation, traçabilité, reproductibilité, robustesse, validité physique proxy, couverture experte).
