...
def main():
    ...
    lines.append("- Réponse: **partielle**.")
    lines.append("- Solution: recalibrage unités + normalisation par site + cross-check non-proxy.")
    ...
    with targeted_tests_csv.open("w", encoding="utf-8", newline="") as f:
        ...
        w.writerow(["Q_solver_crosscheck", "Cross-check non-proxy", "independent_solver_large_lattice", "rel_error_vs_reference", "<10%", "P1"])
