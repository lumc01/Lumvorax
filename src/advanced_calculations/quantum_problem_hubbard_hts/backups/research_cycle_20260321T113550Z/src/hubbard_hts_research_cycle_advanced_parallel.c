...
#undef FOPEN_DIAG
    ...
    for (int ci = 0; ci < c_n; ++ci) {
        ...
        /* C59-ULTRA : 14 000 steps pour TOUTES les tailles — ZÉRO réduction, ZÉRO exception.
         * Règle absolue : capture 100% sans filtre. Milliards de calculs/logs — TOUT capturé. */
        cp.steps = 14000;
