...
DEBUG_OBJECTS = $(OBJ_DEBUG_DIR)/memory_tracker.o $(OBJ_DEBUG_DIR)/forensic_logger.o $(OBJ_DEBUG_DIR)/ultra_forensic_logger.o $(OBJ_DEBUG_DIR)/enhanced_logging.o $(OBJ_DEBUG_DIR)/logging_system.o
